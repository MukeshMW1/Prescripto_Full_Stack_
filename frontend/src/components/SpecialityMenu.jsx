...
const SpecialityMenu = () => {
 ...
 <div className="flex gap-4 mt-5 justify-center items-center overflow-scroll w-full">
        

{specialityData.map((data ,index)=>(
    <Link to={`/doctors/${data.speciality}`} key= {index} className="flex flex-col gap-2  items-center transition-all transform duration-300 hover:-translate-y-2  ">
    <img src={data.image} alt="" className='md:w-[88px] w-[70px]' />
